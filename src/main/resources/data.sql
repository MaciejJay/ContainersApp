...
INSERT INTO SHIPOWNER (id, prefix, short_name, full_name)
VALUES (nextval('Shipowner_seq'), 'APMU', 'Maersk', 'Maersk Line');

INSERT INTO CONTAINER (no_container, container_type, shipowner_id)
...
VALUES (nextval('damage_seq'), '2020-02-15', '123', '2345', 'podloga w znacznym stopniu zniszczona', 'username', '123456789');

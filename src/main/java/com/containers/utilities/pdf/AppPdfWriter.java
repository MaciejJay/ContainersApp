...
//    static Set<Damage> damageSet = new HashSet<>();
...
//
//
//            damage = new Damage(LocalDate.now(), StatusEnum.CONTAINER_UNUSABLE, "Description", container, null, containerDamage, user);
//            user = new User("Admin", "Adam", "Adminowy", "a@a.pl");
//            damageSet.add(damage);
//            container = new Container("CNUM123", "PIN123", "40", damageSet);
